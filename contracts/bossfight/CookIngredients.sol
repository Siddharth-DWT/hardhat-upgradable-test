...
contract CookIngredients is  ReentrancyGuard, Ownable, Pausable{
    ...
    constructor(address _ingredientsERC1155, address _bossCard, address _pancakeERC1155) {
        ingredientsERC1155 = _ingredientsERC1155;
        bossCardERC1155Address = _bossCard;
        pancakeERC1155 =_pancakeERC1155;
    }

    function updateContractAdress (address _ingredientsERC1155, address _bossCard, address _pancakeERC1155) public onlyOwner{
        ingredientsERC1155 = _ingredientsERC1155;
        bossCardERC1155Address = _bossCard;
        pancakeERC1155 =_pancakeERC1155;
    }

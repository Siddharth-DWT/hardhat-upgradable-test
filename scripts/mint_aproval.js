...
async function main(){
    ...
    // FEED
    await approveContract(CONTRACT_NAME_MAP.PancakeNftERC11155,PancakeNftERC11155,address.Feed)
    await approveContract(CONTRACT_NAME_MAP.IngredientsERC11155,IngredientsERC11155,address.Feed, true)
    await approveContract(CONTRACT_NAME_MAP.BossCardERC1155,BossCardERC1155,address.Feed, true)
